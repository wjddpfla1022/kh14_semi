...
<script type="text/javascript">
        $(function(){
            ...
            var status={
                ...
                memberEmailCheckValid:false,//닉네임 중복 검사
            ...
            $("[name=memberIdInput]").blur(function(){
                //step1 : 아이디에 대한 형식 검사
                    ...
                    $.ajax({
                        ...
                        success: function(response){
                            ...
                            if(status.memberIdCheckValid){
                                $("[name=memberIdInput]").addClass("success")
                            }
                            
                            else
                                $("[name=memberIdInput]").addClass("fail2")
                        }
                    });
                }
                else{
                        $("[name=memberIdInput]").addClass("fail")
                }
            });
            $("[name=memberPwInput]").blur(function(){
                    ...
                    $.ajax({
                        ...
                        success:function(response){
                            ...
                            if(status.memberNicknameCheckValid){
                                $("[name=nicknameInput]").addClass("success")
                            }
                            else{
                                $("[name=nicknameInput]").addClass("fail2");
                            }
                        }
                    })
                }
                else{
                    $("[name=nicknameInput]").addClass("fail")
                }
                
            });
            $("[name=emailInput]").blur(function(){
                var target=$(this).val();
          ...
          //이메일 인증 관련 처리
            ...
            $(".field-show").change(function(){
                ...
                $("[name=memberPwInput],.pwInput2").attr("type",checked?"text":"password");
            });
...
<body>
    <form class="check-form" action="#" method="post" autocomplete="off" enctype="multipart/form-data">
            ...
            <div class="multipage">
                <div class="page">
                    <div class="row left">
                        ...
                        <input class="idInput field w-100" name="memberIdInput" type="text" placeholder="8~20자 영문 소문자와 숫자">
                ...
                <div class="page">
                    <div class="row left">
                        ...
                        <input class="field w-100 pwInput1" name="memberPwInput" type="password" placeholder="영문대소문자, 숫자, 특수문자를 포함한 8~16자">
                ...
                <div class="page">
                    <div class="row">
                        <label>닉네임<i class="fa-solid fa-asterisk red"></i>
                            <input type="text" class="field w-100" name="nicknameInput" placeholder="한글과 숫자로 이루어진 2~7글자 ">
        ...
        <div class="row float-box">
            <button type="submit" class="btn btn-positive btn-submit">가입하기</button> 
