										...
										<table class="table table-border-top">
											<thead>
												<tr class="tr-table-top">
													<th width="35%" class="th-table-top">일시</th>
													<th width="15%">구분</th>
													<th width="50">사유</th>
												</tr>
											</thead>
											<tbody>
												...
												<tr class="table-border-middle">
													<td class="td-table-bottom">
														<fmt:formatDate value="${blockDto.blockTime}"	pattern="y년 M월 d일 E H시 mm분"/>
													</td>
													<td class="td-table-bottom">${blockDto.blockType}</td> <!--구분 -->
													<td class="td-table-bottom">${blockDto.blockMemo}</td> <!-- 사유 --> 
												</tr>
												</c:forEach>
											</tbody>
										</table>
