...
<jsp:include page="/WEB-INF/views/template/header.jsp"></jsp:include> 
    ...
    <div class="container w-600 center">
        ...
        <form action="update" method="post" autocomplete="off">
            ...
            <div class="row">
                <label>할인율</label>
                <input type="number" name="itemDiscountRate" class="field" value="${itemDto.getItemDiscountRate()}">
            </div>
            <div class="row">
            	<label>색상</label>
            	<input type="text" name="itemColor" class="field" value="${itemDto.getItemColor()}">
            </div>
        <div class="right">
