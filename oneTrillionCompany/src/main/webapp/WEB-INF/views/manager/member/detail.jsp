...
<!-- 			</div> -->
			<div class=custom-menu>
					<a href="${pageContext.request.contextPath}/qna/list?column=qna_writer&keyword=${memberDto.memberId}&exactMatch=true">
						<span id="top-location">Q&A</span>
						<span id="bottom-location">문의내역 조회</span>
					</a>
			</div>			
			<div class=custom-menu>
					<a href="${pageContext.request.contextPath}/review/list?column=review_writer&keyword=${memberDto.memberId}&exactMatch=true">
						<span id="top-location">Review</span>
						<span id="bottom-location">리뷰내역 조회</span>
					</a>
			</div>			
			<div class=custom-last-menu>
					<a href="${pageContext.request.contextPath}/manager/member/blockList?column=block_member_id&keyword=${memberDto.memberId}&exactMatch=true">
