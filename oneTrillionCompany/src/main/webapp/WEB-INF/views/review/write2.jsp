...
<form action="write" method="post" enctype="multipart/form-data" autocomplete="off">
    <div class="container w-800">
	        <div class="row">
	         ...
	         <div class="row">
	            <label>내용</label>
	            <textarea name="reviewContent" rows="10" class="w-100"></textarea>
	        </div>
            ...
            <div class="row">
                ...
                <input type="text" name="reviewScore" class="w-100">
            </div>
            
	        <div class="row">
	             <input type="file" name="attach" class="w-100" accept="image/*">
	        </div>
