				...
				<div class="swiper-wrapper">
					...
					<c:forEach var="item" items="${swiperList}">
						<div class="swiper-slide">
							<a href="${pageContext.request.contextPath}/item/detail?itemNo=${item.itemNo}"><img
								src="${pageContext.request.contextPath}/item/image?itemNo=${item.itemNo}" style="width:200px; height:240px;"></a>
		...
		<div class="row image-align w-5">
			<c:forEach var="item" items="${mainList}">
				<a href="${pageContext.request.contextPath}/item/detail?itemNo=${item.itemNo}">
					<img src="${pageContext.request.contextPath}/item/image?itemNo=${item.itemNo}" style="width:200px; height:240px;">
	...
	<div class="container w-700">
		...
		<div class="row image-align">
			<c:forEach var="item" items="${outerList}">
				<a href="${pageContext.request.contextPath}/item/detail?itemNo=${item.itemNo}"><img
					src="${pageContext.request.contextPath}/item/image?itemNo=${item.itemNo}" style="width:200px; height:240px;">
					<div class="name">${item.itemName}(${item.itemColor})</div>
					<div class="price"><span class="gray" style="text-decoration : line-through"> ${item.itemPrice}원 </span> ${item.itemSalePrice}원</div>
				</a>
			</c:forEach> 
